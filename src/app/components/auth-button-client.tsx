    ...
    <header>
      {
        session === null
          ? (
            <button style={{ cursor: 'pointer' }} onClick={handleSignIn} type="button" className="text-white bg-[#24292F] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5  focus:ring-gray-500 hover:bg-[#050708]/30 mr-2 mb-2">
              <div style={{ display: 'flex', width: '200px', textAlign: 'center', height: '40px' }}>
                ...
                <b style={{ textAlign: 'center', margin: 'auto' }}>Inicia sesion con Github </b>
              </div>
            </button>)
