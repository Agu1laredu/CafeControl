    ...
    <header>
      {
        ...
        session === null
          ? (
            ...
            <button style={{ cursor: 'pointer', width: '55px', height: '55px' }} onClick={handleSignIn} type="button" className="text-white bg-[#24292F] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5  focus:ring-gray-500 hover:bg-[#050708]/30 mr-2 mb-2">
